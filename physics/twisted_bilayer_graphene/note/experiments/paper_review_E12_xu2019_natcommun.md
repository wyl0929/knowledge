 ...
 * @FilePath     : /.agents/home/wyl/project/knowledge/physics/twisted_bilayer_graphene/note/experiments/paper_review_E12_xu2019_natcommun.md
 * @Description  :
-->
<!--
 * @Author       : AI 精读 (research_onboarding_skill)
 * @Date         : 2026-08-06
 * @FilePath     : /project/knowledge/physics/twisted_bilayer_graphene/note/experiments/paper_review_E12_xu2019_natcommun.md
...
低温输运：纵向电阻中巨幅 AB 振荡 + 密度依赖振荡 + Hall 符号反复反转。核心特征：异常大的电阻振荡幅度、多个子能带特征——相干运动沿三角形网络。通过响应围绕闭合三角形环路组织且无法用 2D 体输运解释区分边缘 vs 体。
