 ...
 * @FilePath     : /.agents/home/wyl/project/knowledge/physics/twisted_bilayer_graphene/note/theory/paper_review_T13_fujimoto2021_prb.md
 * @Description  :
-->
<!--
 * @Author       : AI精读 (research_onboarding_skill, Phase 4)
 * @Date         : 2026-08-06
 * @FilePath     : /project/knowledge/physics/twisted_bilayer_graphene/note/theory/paper_review_T13_fujimoto2021_prb.md
...
- **"AB 振荡的规范场解释"已确认不存于本 review**: 本 review 未含该句（grep "AB" 仅命中 "AB/BA 畴壁"）；该无源句曾存于旧版 **cards.md T13**（原文全文无 AB 振荡讨论，grep "Aharonov"=0；引用列表无 Xu/Rickhaus），已于 08-19 删除并改为 "滑动 Chern 数泵浦的体-边对应 📜Q"。本 review 与卡片一致，仅登记。依据: §B.5#14 + cards.md T13。
