 ...
 * @FilePath     : /.agents/home/wyl/project/knowledge/physics/twisted_bilayer_graphene/note/theory/paper_review_T15_debeule2020_prl.md
 * @Description  :
-->
<!--
 * @Author       : AI精读 (research_onboarding_skill, Phase 4)
 * @Date         : 2026-08-06
 * @FilePath     : /project/knowledge/physics/twisted_bilayer_graphene/note/theory/paper_review_T15_debeule2020_prl.md
...
AA 节点散射作为双通道问题 → 畴壁态可视为手征 zigzag 模或赝朗道能级态（取决于散射相位参数）。统一网络图景和 TZM 图景。

### Q3: 理论如何与实验结合?
识别哪种散射产生 AB 振荡、哪种产生 SdH 行为。解释 AB 振荡对温度稳健的原因。为 Xu 2019 巨幅 AB 振荡提供机制。
