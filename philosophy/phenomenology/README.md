...
Output path / 输出路径: /home/wyl/project/knowledge/philosophy/phenomenology

Profile source / 背景来源: /home/wyl/.agents/skills/research-onboarding/profiles/general_interest_profile.md
...
本目录用于建立一个可持续阅读和扩展的领域入门包。它帮助用户理解概念、主要路线、代表材料和可继续追问的问题；默认不把兴趣了解强行推向研究选题或项目计划。
...
- `15_primary_materials_and_reading_path.md`
- `16_key_questions_and_cases.md`
- `90_QA.md`
- `99_update_log.md`

## 下一步

建议使用：`prompts/phase_user_brief_capture.md -> phase1_term_breaking.md -> phase2_field_map.md -> phase3_paper_parsing.md -> phase_beginner_guide.md -> phase_summary_overview_report.md -> phase_readability_pass.md`。

## 自检命令

```bash
python research-onboarding/scripts/check_pack_integrity.py /home/wyl/project/knowledge/philosophy/phenomenology
```
